...
Future fn_query() async {
  ...
  */
  ...
  results = await conn.query(
      ...
      'select rrhh_empleado_nombre_a, rrhh_empleado_nombre_b, rrhh_empleado_apellido_a, rrhh_empleado_apellido_b from rrhh_empleado');

  users.clear();
  for (var row in results) {
    print(
        'rrhh_empleado_nombre_a: ${row[0]}, rrhh_empleado_nombre_b: ${row[2]} ');
    debugPrint(results.toString());
    llenar_tabla(row[0], row[2]);
...
/*
  ...
  addUsers(String firstName, String lastName) {
    var user = new User();
...
llenar_tabla(String nombre, String Apellido) {
